...
```{r ore_connect, echo=FALSE, collapse=TRUE}
########################################################################################
############################     Connecting to ORE             #########################
########################################################################################

library(ORE)
invisible(ore.connect("rquser",service_name="orcl",host="localhost",password="welcome1", all=TRUE))

```

```{r Importing_Libraries, echo=FALSE, collapse=TRUE}
########################################################################################
